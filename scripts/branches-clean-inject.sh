...
#   G. ветка без своего коммита (голова на первой линии ствола — живая волна до
#      сборки) в счёт не идёт: влито нечего, перепись её не снимет (ws#847,
#      круг 2); законный близнец — `landed` со своим коммитом — в счёте (C).
#
...
echo
if [ "$fail" -eq 0 ]; then
  echo "branches-clean-inject: 7 утверждений, все выполнены — хук способен заговорить И смолчать"
else
