...
#
#   * `git branch --merged` — до 2026-09-22 вливали схлопыванием и через
#     накопительную ветку, и HEAD ветки предком ствола не становился: `--merged
...
# После (2026-09-24, 16 заданий, живой клон продукта, 494 локальных и 230 на
