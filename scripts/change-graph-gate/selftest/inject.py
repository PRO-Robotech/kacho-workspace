...
INJECTIONS = [
    ...
    (
        ...
        #
        # Класс поэтому ОСТАЁТСЯ, и граница #493 («радиус инъекции семейства
        # известен и не растёт») опровергнута: радиус есть множество опрошенных
        # кейсов семейства, а растит его полоса ФИКСТУР (41bca7dc), не полоса
        # семейства (94331c8f) — то есть чужая, ровно как у ветвей ядра. Здесь
        # починен ЭКЗЕМПЛЯР; класс со своим предикатом снятия — #510.
