...
echo "перепись: прочитано SKILL.md — ${#files[@]}; ссылок по имени раздела — $named_refs, из них ПРОВЕРЕНО $checked_refs (норма найдена в .claude/rules/), вне корпуса норм $offcorpus_refs; ссылок номером строки — $numbered_refs"
