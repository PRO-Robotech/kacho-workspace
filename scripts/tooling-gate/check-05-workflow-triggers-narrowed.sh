...
#
# Что запрещает эта проверка (#282). `.claude/rulebook/git-issues.md` §«Накопительная
# релизная ветка» и `.claude/rulebook/multi-agent-flow.md` §8 обещают: конвейер тратится
