...
echo "== check-18: страж монитора флоу =="
...
b="$(mksandbox)"; run 0 "$b" "чистое дерево — молчит" \
    check-18-wave-monitor-fires-on-its-triggers.sh
...
# единица — шапка `check-18-wave-monitor-fires-on-its-triggers.sh`, разделы
