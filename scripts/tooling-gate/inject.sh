...
# Положительную снимает ОДНА КОНСТАНТА на все одиннадцать текстов: блок есть, он
...
# Отрицательную половину снимает БЛОБ: один текст, называющий предметы ВСЕХ
# одиннадцати осей разом. Положительная половина на нём проходит — «своё» в
# строке есть, — и снимает её только запрет на чужое.
b="$(mksandbox)"
if mr_patch "$b/$HK_REL" \
