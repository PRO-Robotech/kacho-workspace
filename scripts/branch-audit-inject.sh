...
#
# Проверяется восемнадцать утверждений (A, A2, B, C, D, E, F, G, H, I, J, K, L,
# M, N, O, P, Q):
...
echo
if [ "$fail" -eq 0 ]; then
  echo "branch-audit-inject: 18 утверждений, все выполнены — перепись способна упасть И смолчать"
else
