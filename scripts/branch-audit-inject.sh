...
#
# Проверяется двадцать девять утверждений (A, A2, B, C, D, E, F, G, H, I, J, K, L,
...
echo
if [ "$fail" -eq 0 ]; then
  echo "branch-audit-inject: 29 утверждений, все выполнены — перепись способна упасть И смолчать"
else
