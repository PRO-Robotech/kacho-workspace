...
(`multi-agent-flow-shared-tree.md` §8): вердикт выносится по стволу, отставание копии
называется ЧИСЛОМ.
