...
#
# preservation-proof.sh — сохранность работы полосы после схлопывания, переноса
# или слияния, доказанная СОДЕРЖИМЫМ. Исполняемая форма нормы
...
preservation-proof.sh [-C <репо>] --predict <база> <голова полосы>
  база   — ствол, от которого полоса ответвилась (ветка или sha)
  голова — голова полосы ДО схлопывания/слияния
