...
**Что контур добавляет к шагам §2** — четыре следствия; условия переходов и координаты
...
Шаги 2.4 и 2.5 контур не меняет — их предмет внутри изменения, а не на его границах.
