...
11. **Test-first (строгий TDD) — ОБЯЗАТЕЛЬНО — и НЕ мёрджить новый RPC / новое proto-поле / новый ресурс / багфикс без тестов в том же PR.**
