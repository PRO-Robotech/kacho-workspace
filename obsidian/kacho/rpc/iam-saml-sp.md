...
> Ни маршрутов `/saml`, ни выделенного листенера, ни моста в дереве нет; таблица `saml_sessions` дропнута `0006_drop_scim_saml_break_glass.sql`. Вход — OIDC через Hydra, единым фасадом которой выступает iam.
>
