...
> живого предмета. **Файла нет**: контракт снят задачей
> [`kacho#1043`](https://github.com/PRO-Robotech/kacho/issues/1043) вместе с сервером,
> который его реализовывал (MR #1151 в ствол).
>
