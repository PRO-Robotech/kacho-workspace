...
> Прочитай `.claude/rules/vault.md` §«Obsidian vault — обязательный context-источник и
> trail» — канон хранилища. В корневом `CLAUDE.md` его раздела нет и не было с перехода
> на модель «правило закреплено за агентом» (решение владельца 2026-09-17): норму держит
> файл правила, закреплённый за `vault-scribe`, а не протокол воркспейса.
>
