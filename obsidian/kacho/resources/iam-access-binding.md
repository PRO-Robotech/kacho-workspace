...
> [!note] Селекторная выдача на людей: источник связи с аккаунтом — членства, а не колонка
> На линии `release/identity-3` (в стволе **нет** на 2026-08-24) аккаунты объекта перестали
> быть скаляром и стали набором: у личности их столько, сколько у неё членств. До этого план
> чтения материализации селекторов брал аккаунт человека из легаси-колонки его строки, тогда
> как цепь областей ту же связь уже брала из членств. Предмет, форма решения и граница —
> [[KAC/issue-1172]].
