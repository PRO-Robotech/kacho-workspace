...
> в дереве ни разу** — даже в документации. Источник истины по таблице маршрутов —
> [[vpc-routetable]] (`kacho_vpc.route_tables`, prefix `rtb`).
>
> **Перемерено 2026-08-12** (`4d26e330`): ноль подтверждён. Прежняя редакция
> противопоставляла этот ноль соседнему [[resources/kacho-vpc-operator-KachoSubnet]],
> который «хотя бы упомянут на страницах документации», — сегодня и там ноль. Отличие,
> ради которого писалось противопоставление, исчезло.
