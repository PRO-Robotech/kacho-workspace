...
- `(*github.com/PRO-Robotech/kacho-vpc/internal/handler.OperationHandler).Cancel` — (undocumented — see C4)
- `(*github.com/PRO-Robotech/kacho-vpc/internal/handler.OperationHandler).Get` — (undocumented — see C4)
