...
> `outbox/drainer` (claim + применение), `outbox/reconciler` (возврат отравленных
> строк в работу — и только это, см. kacho#760: два прохода сверки с состоянием
> сняты, их предикаты были недостижимы by construction),
