...
verified_against: "координаты записки (раскладка каталогов, гейты репо-гигиены, правило исключения секретов) сверены с деревом продукта 1653387b (2026-08-06); замеры времени CI и числа пакетов построчно не пересматривались"
---
