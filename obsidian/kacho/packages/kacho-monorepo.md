...
`github.com/PRO-Robotech/kacho` — **один Go-модуль на всю платформу**; с под-фазы TF-1 рядом
живёт второй, `…/terraform` (провайдер), который продукт не импортирует и в граф его
зависимостей не входит — см. [[packages/terraform-provider]]. Создана
