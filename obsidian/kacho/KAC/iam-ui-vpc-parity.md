...
| 4 | List pages → ResourceListPage | in-progress | — |
| 5 | Detail → ResourceShell + DETAIL_EXTENSIONS | in-progress | — |
| 6 | Forms → InlineResourceForm-ветки + modal mount | planned | — |
| 7 | Nav / breadcrumbs / Access cosmetics | planned | — |
| — | Tests (vitest/newman RED→GREEN) + verify | ongoing | — |
...
- [ ] List pages (#3)
- [ ] Detail + DETAIL_EXTENSIONS (#4)
- [ ] Forms (#5)
- [ ] Nav / breadcrumbs (#6)
- [ ] Tests RED→GREEN + `tsc`/build/newman зелёные (#7)
