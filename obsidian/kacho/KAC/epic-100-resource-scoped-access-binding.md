...
>
> **done.** **Внутри записки статус уже стоял `done`** — расходилась только шапка. Два места об одном предмете, из которых верно одно; сверка по дереву подтверждает тело: миграция таблицы целей привязки на месте, а поле цели переизобретено в редизайне под новым номером с сохранением надгробий на старых. Шапка приведена к телу.
