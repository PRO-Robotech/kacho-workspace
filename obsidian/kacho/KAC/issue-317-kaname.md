...
tags:
  ...
  - kacho-iam
  - fix
verified_against: "Перемер 2026-09-26: голова задачи 2b203955a36 — предок коммита слияния волны fc9f5aff19c в ветку эпика 357 и не предок origin/main cbbac984b7b (`git merge-base --is-ancestor`). Сверка 2026-09-24: PRO-Robotech/kaname: голова задачи 2b203955a36f651c79323825c1c04509fc0a9bbb (= origin/317) — предок головы сборки 2f45e7c8aa0 и origin/358, не предок origin/357 и origin/main (`git merge-base --is-ancestor`), 2026-09-24. Предикат снятия задачи мной не перемерялся"
---
