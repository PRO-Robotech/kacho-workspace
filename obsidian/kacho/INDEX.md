...
| Пакеты | `packages/` | 118 |
| Журнал работ (KAC) | `KAC/` | 245 |
| Уроки — классы дефектов | `lessons/` | 29 |
...
| [[KAC/issue-211-identity-account-decoupling\|Отрыв аккаунта от пользователя — приёмка перед кодом (эпик #211)]] | в работе (in-progress) |
...
| [[KAC/issue-447\|issue-447 — ui: раздел администрирования и недостижимая админ-плоскость]] | в работе (in-progress) |
