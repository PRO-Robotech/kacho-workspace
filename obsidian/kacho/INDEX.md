...
| Пакеты | `packages/` | 119 |
| Журнал работ (KAC) | `KAC/` | 356 |
| Уроки — классы дефектов | `lessons/` | 46 |
...
| [[KAC/issue-921\|#921 — номер миграции: метка времени вместо номера задачи]] | — |
...
| [[KAC/issue-955\|#955 — объявление сбора величин: один механизм вместо двух]] | — |
