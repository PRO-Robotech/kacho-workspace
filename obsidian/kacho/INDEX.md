...
| Пакеты | `packages/` | 119 |
| Журнал работ (KAC) | `KAC/` | 311 |
| Уроки — классы дефектов | `lessons/` | 38 |
...
| [[KAC/issue-747\|#747: приёмка R7-3 — внешний движок прав снимается, решение вычисляется в своей базе]] | в работе (in-progress) |
