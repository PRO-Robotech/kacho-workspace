...
| Пакеты | `packages/` | 119 |
| Журнал работ (KAC) | `KAC/` | 320 |
| Уроки — классы дефектов | `lessons/` | 40 |
...
| [[KAC/issue-747\|#747 (R7-3): полный отказ от внешнего движка прав — решение вычисляется в своей базе]] | в работе (test) |
...
| [[KAC/issue-883\|#883: потолок при незанятых ресурсах — посадка базы против срыва хвоста]] | в работе (in-progress) |
