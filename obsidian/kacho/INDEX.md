...
| Пакеты | `packages/` | 119 |
| Журнал работ (KAC) | `KAC/` | 310 |
| Уроки — классы дефектов | `lessons/` | 37 |
...
| [[KAC/issue-732\|Цепь областей читается одним обращением, а не обходом (S2 линии roles-new)]] | в работе (test) |
