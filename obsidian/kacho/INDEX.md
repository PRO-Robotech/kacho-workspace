...
| [[KAC/issue-240\|issue-240 — перепись веток принимает отставание за расщеплённую работу]] | в работе (test) |
| [[KAC/issue-241\|issue-241 — ветки: влитая локальная ветка не снимается и не видна]] | в работе (test) |
...
| [[KAC/issue-297\|#297: отказ снести группу целей nlb называет блокирующие строки]] | в работе (test) |
...
| [[KAC/issue-434\|issue-434 — e2e: сквозной прогон краснеет каждый третий раз]] | в работе (in-progress) |
