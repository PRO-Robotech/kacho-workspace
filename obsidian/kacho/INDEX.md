...
**Висячие ссылки.** Всего **340** на **217** целей — это и есть перечень
ненаписанного (записки категорий 162, уроки 101, номера KAC без trail 77).
За 2026-08-06 перечень сократился ровно на одну цель: `rpc/registry-registry-service`
перестала висеть потому, что записку **написали**, а не потому, что ссылку
переименовали в простой текст.
...
| Уроки — классы дефектов | `lessons/` | 3 |
