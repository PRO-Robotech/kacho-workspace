...
| [[KAC/issue-1028\|#1028: у проекции роли один писатель]] | в работе (test) |
| [[KAC/issue-1030\|#1030: каталог модуля таблицами со составным ключом живости]] | в работе (in-progress) |
...
| [[KAC/issue-1088\|#1088: схема манифеста домена — контракт и загрузчик в дереве]] | живо (done) |
...
| [[KAC/release-modules-2026-09-01\|Линия release:modules — каталог модуля как данные]] | в работе (in-progress) |
