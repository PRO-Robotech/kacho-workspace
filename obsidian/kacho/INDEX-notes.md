...
| [[KAC/issue-492-ws\|ws#492: фикстура вердикта артефакта заведена, правила у неё ещё нет]] | в работе (in-progress) |
| [[KAC/issue-493\|issue-493 — перечень ожиданий у инъекций ядра выписан именами]] | живо (done) |
| [[KAC/issue-494-ws\|ws#494: диагностика семейства драйвера впервые получила исполняемый кейс]] | в работе (in-progress) |
...
| [[KAC/issue-502-ws\|ws#502: норму «диагностика берётся из приёмки» не держала ни одна проверка]] | в работе (test) |
...
| [[KAC/issue-506-ws\|ws#506: adapter-gate — конвейер не звал ни набор, ни его доказательство падучести]] | в работе (test) |
| [[KAC/issue-510-ws\|ws#510: SDD-1 — радиус инъекции семейства растёт от чужой полосы фикстур]] | в работе (test) |
