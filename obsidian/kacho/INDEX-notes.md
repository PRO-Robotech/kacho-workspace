...
| [[KAC/issue-1273\|kacho#1273: iam Ф7 — ключи доступа (WebAuthn): сервер, привязка, судьба трёх ключей]] | в работе (to-do) |
...
| [[KAC/issue-1439\|#1439: Шапка гейта подписки соответствует оставшимся проверкам]] | живо (done) |
...
| [[KAC/issue-1585\|#1585: Шапка foreignclouds называет фактический предмет и источник счёта]] | живо (done) |
...
| [[KAC/issue-1660\|#1660: Ожидание дренажа снято вместе с прежним механизмом журнала]] | живо (done) |
| [[KAC/issue-1662\|#1662: Команда задачи выбирает фактическую пробу artifactgates]] | живо (done) |
...
| [[KAC/issue-2155\|#2155: доказательства падучести лежали в дереве и не звались ни одним прогоном]] | живо (done) |
...
| [[KAC/issue-2175\|#2175: Снимок скана сохраняется при отсутствии Trivy и отказе восстановления]] | живо (done) |
...
| [[KAC/issue-2218\|#2218: Деривация корня listfiltergate принадлежит закреплённому corelib]] | живо (done) |
...
| [[KAC/issue-2230\|#2230: Достижимость внутренних псевдоверсий и main ancestry]] | в работе (planned) |
...
| [[KAC/issue-2258\|#2258: Импорты объявленных потребителей в архиве выпуска]] | в работе (planned) |
...
| [[KAC/issue-2364\|#2364: DO-блок и действующая SQL-функция различаются в гейте роста таблиц]] | живо (done) |
...
| [[KAC/issue-2550\|#2550: Гейт Make проверяет команды канонической обёртки]] | живо (done) |
| [[KAC/issue-257\|issue-257 — перепись веток: раздел «работа в стволе не вся» давал ложные находки]] | живо (done) |
| [[KAC/issue-2588\|#2588: Производитель поставки готового дерева общей библиотеки]] | в работе (planned) |
...
| [[KAC/issue-2632\|#2632: Условия снятия проблемы ранеров подтверждены последовательной выборкой]] | живо (done) |
...
| [[KAC/issue-602\|#602: Все объявленные команды lint консоли исполняются]] | живо (done) |
