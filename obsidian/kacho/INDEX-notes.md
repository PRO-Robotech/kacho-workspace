...
| [[KAC/issue-254\|#254: правило обещало владельцу послабление защиты ветки, которого нет]] | живо (done) |
...
| [[KAC/issue-459\|#459: замер строк кода — инструментом, а не разбором дерева заново]] | в работе (test) |
