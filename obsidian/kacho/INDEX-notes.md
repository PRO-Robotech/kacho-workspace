...
| [[KAC/issue-106-kaname\|kaname#106: группу пишущих кортежи объявляет манифест службы; module-quota-readers снята миграцией (S2б)]] | в работе (test) |
...
| [[KAC/issue-184-kaname\|kaname#184: копия каталога прав обязана покрывать СВОЙ контракт — строка Resolve и гейт]] | в работе (test) |
