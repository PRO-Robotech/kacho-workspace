...
| [[KAC/issue-2173\|#2173: задокументированный вывод repohygiene называл снятую координату]] | живо (done) |
...
| [[KAC/issue-561\|issue-561 — перепись веток по продукту: посылка опровергнута, `comm` снят четырьмя часами раньше]] | в работе (test) |
