...
| [[KAC/issue-485\|#485: отсутствие признака СТРОИТСЯ, а не отыскивается среди кейсов]] | в работе (test) |
| [[KAC/issue-486\|issue-486 — третий собственный отказ ядра не был доказан ничем]] | в работе (test) |
| [[KAC/issue-488-ws\|ws#488: колонка приёмки, которая не может быть наблюдением]] | в работе (test) |
| [[KAC/issue-489\|#489: пакет репозитория compute не собирался под своим признаком]] | в работе (test) |
| [[KAC/issue-490-ws\|ws#490: перечень под верным числом обрывался молча]] | в работе (test) |
| [[KAC/issue-490\|issue-490: адъюдикация объявленных разрывов не смотрела на ствол]] | в работе (test) |
| [[KAC/issue-491-ws\|ws#491: долгий прогон молчал, и «идёт» было неотличимо от «повис»]] | в работе (test) |
| [[KAC/issue-493\|issue-493 — перечень ожиданий у инъекций ядра выписан именами]] | в работе (test) |
...
| [[KAC/issue-503-ws\|ws#503: доказательство падучести prove.py не запускалось вовсе]] | в работе (test) |
| [[KAC/issue-503\|#503: сетевая поверхность сборки образа шире его графа импортов]] | в работе (test) |
| [[KAC/issue-504-ws\|ws#504: оснастку контура SDD-1 не звал ни хук, ни конвейер]] | в работе (test) |
