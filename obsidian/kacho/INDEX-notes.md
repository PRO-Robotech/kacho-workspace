...
| [[KAC/issue-1016\|#1016: эпик: единый поток изменений ресурсов для всех модулей]] | в работе (in-progress) |
...
| [[KAC/issue-1397\|#1397: общая форма подписки не принимает журнал смены субъекта]] | в работе (test) |
