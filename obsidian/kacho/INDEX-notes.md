...
| [[KAC/issue-1774\|#1774: письмо приглашения уходит само — ссылка снята, повторная отправка и предел частоты]] | в работе (test) |
...
| [[KAC/issue-2076\|#2076: Kaname — остаток имени платформы в дереве службы, пачка D]] | в работе (in-progress) |
