...
| [[KAC/issue-1439\|#1439 — repohygiene: описание формы подписки следует действующим проверкам]] | в работе (in-progress) |
...
| [[KAC/issue-1483\|#1483 — Край разрешает типы Any, упакованные владельцами]] | живо (done) |
...
| [[KAC/issue-1585\|#1585 — foreignclouds: объяснение охвата совпадает с производителем переписи]] | в работе (in-progress) |
...
| [[KAC/issue-1872\|#1872 — Чистота go mod tidy проверяется в CI]] | живо (done) |
...
| [[KAC/issue-1910\|#1910 — Гейт отката определяет направление слияния]] | живо (done) |
| [[KAC/issue-1911\|#1911 — Объявленные снятия сохраняют смысл между отправками]] | живо (done) |
...
| [[KAC/issue-2116\|#2116 — Инертные директивы подавления сняты]] | живо (done) |
...
| [[KAC/issue-2148\|#2148 — Словарь отрицательных кейсов совпадает с разрешениями]] | живо (done) |
...
| [[KAC/issue-2175\|#2175 — Доказательство скана сохраняет исходную конфигурацию]] | в работе (in-progress) |
...
| [[KAC/issue-2178\|#2178 — Прямой и общий запуск самопроверок согласованы]] | история (wontfix) |
...
| [[KAC/issue-2184\|#2184 — Гейт проверяет годность имени сверки TLS]] | живо (done) |
...
| [[KAC/issue-2424\|#2424: два раздела приёмки требовали противоположного — разрешено различением ролей]] | в работе (in-progress) |
...
| [[KAC/issue-2470\|#2470 — Постановка о пустой переписи замыкания опровергнута]] | история (wontfix) |
| [[KAC/issue-254\|#254: правило называло enforce_admins false, в обоих репозиториях true]] | живо (done) |
| [[KAC/issue-2550\|#2550 — Make-команды под stand-up входят в перепись гейта]] | в работе (in-progress) |
| [[KAC/issue-257\|issue-257 — перепись веток: раздел «работа в стволе не вся» давал ложные находки]] | живо (done) |
| [[KAC/issue-2578\|#2578 — migrator: комментарии ссылаются на действительные проверки]] | в работе (in-progress) |
| [[KAC/issue-2580\|#2580 — Третий исход интеграции доезжает до читателя CI]] | в работе (in-progress) |
| [[KAC/issue-259\|#259: брошенные рабочие копии держали влитые ветки]] | живо (done) |
| [[KAC/issue-2590\|#2590 — migrator: маршрут notice-проб описан по действующему CI]] | в работе (in-progress) |
| [[KAC/issue-2591\|#2591 — repohygiene: граница проверки формы носителя названа точно]] | в работе (in-progress) |
| [[KAC/issue-2592\|#2592 — Комментарий помощника формы подписки следует действующей переписи]] | в работе (in-progress) |
...
| [[KAC/issue-570\|рулы: ядро волны сведено к трём файлам, свод читает ревьюер]] | живо (done) |
...
| [[KAC/issue-945\|#945 — Гейт удерживает порядок номеров миграций]] | живо (done) |
