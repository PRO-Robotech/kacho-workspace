...
> [!warning] Архиватора нет; общая очередь аудита не имеет ни одного потребителя (сверено 2026-08-05)
> Ни архиватора, ни клиента объектного хранилища в дереве нет. Важнее частности: **общая**
> очередь `audit_outbox` пишется и не дренится никем — ни в поток, ни в архив, ни в SIEM
> (см. [[iam-to-kafka-audit]]). Пока это так, любая записка про приёмник аудита описывает
> вторую половину моста, у которого нет первой.
