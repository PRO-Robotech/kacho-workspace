...
gi-commit-form-by-hook · форму сообщения (строки выше) судит хук `commit-msg`, а не ревью: рецензент формой круга не открывает · ЗАВЕСТИ gi-commit-msg-hook (corelib#25, kaname#356; воркспейс и kacho — задачи нет) · red: форма коммита — замечание ревью; принят заголовок длиннее 72 знаков
