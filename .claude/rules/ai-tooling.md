...
at-load-target-resolves · имя, которое тело агента велит ЗАГРУЗИТЬ, существует в дереве — в трёх законных формах: `skills:`, `Skill <имя>`, голое имя в кавычках; несработавшая загрузка НЕ ПЕЧАТАЕТ НИЧЕГО, поэтому краснеет ДЕРЕВО · scripts/tooling-gate/check-14-agent-load-targets-resolve.sh · red: `Skill <имя>` без каталога; предзагрузка без каталога; скил без читателя
