...
его выводом: строка без директории и директория без строки — обе находки. На 2026-08-03
перечень называет **12** имён, отслеживаемых директорий в дереве **13**; тринадцатая —
