...
ban19-review-round-one · все блокирующие — в первом круге; круг N+1 судит лишь дельту и закрытие круга N, новое на нетронутом — находка, не ⛔ (кроме безопасности) · вниманием рецензента · red: ⛔ круга N+1 по строке, не тронутой с круга N
ban19-review-diff-only · блокируй только предмет диффа, с предикатом и координатой · вниманием рецензента; ⛔ без предиката диспетчер круга не открывает · red: ⛔ вне диффа либо без команды и файл:строки
