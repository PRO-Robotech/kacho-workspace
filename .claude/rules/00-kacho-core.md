...
ban19-review-round-one · все блокирующие — в первом круге; круг N+1 судит лишь дельту и закрытие круга N, новое на нетронутом — задача строкой «нужен следующий: git-operator», не ⛔; всегда блокируют безопасность, нарушение запрета ban*, маска, пропуск, ослабление проверки · вниманием рецензента · red: ⛔ круга N+1 по строке, не тронутой с круга N, вне исключений
ban19-review-subject-only · блокируй с предикатом и координатой только предмет изменения с его обязательными следствиями вне диффа (импортёры переноса, потребители снятого) и исключения ban19-review-round-one · вниманием рецензента; ⛔ без предиката диспетчер круга не открывает · red: ⛔ вне предмета либо без команды и файл:строки
