...
ban19-review-rounds-in-process · круги «исполнитель → ревью → доработка» — внутри одного процесса диспетчера (`Workflow`), до трёх: замечание рецензента уходит исполнителю дословно, диспетчеру — итог или тупик; третий круг одного рода — смена формы задания (решение владельца 2026-09-24) · процесс `Workflow` диспетчера · red: замечание пересказано диспетчером; четвёртый круг
