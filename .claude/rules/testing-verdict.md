...
operation-proved-by-postcondition · исход ОПЕРАЦИИ бери из её постусловия, спрошенного отдельной командой после, а не из кода: между тобой и ею стоит посредник (труба, хук, фон, харнесс) · scripts/push-verified.sh — образец: ссылка на сервере = отправленная sha · red: «сделано» со слов кода возврата
