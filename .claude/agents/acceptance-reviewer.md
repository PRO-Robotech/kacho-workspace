...
> **Скил, владеющий этим моментом:** `gate-authoring` — твой предмет тот же, что у проверки: СПОСОБЕН ли сценарий упасть. Отдельно спрашивай конструируемость (сценарий, запрещённый схемой, APPROVED не лечит) и парность отрицаний: «отвергнуто» без положительного близнеца неотличимо от «мёртво».
>
