...
- `class-exposure-analyst` — до написания миграции с обратным заполнением или со снятием
  колонки/таблицы: называет условия на код (два написания одного значения в переходном
