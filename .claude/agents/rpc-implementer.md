...
@.claude/rulebook/api-conventions.md · @.claude/rulebook/architecture.md ·
@.claude/rulebook/data-integrity.md · @.claude/rulebook/testing.md ·
@.claude/rulebook/polyrepo.md · skill `evgeniy` (Go-style: UseCase, CQRS-порты,
