...
CANONICAL="$ROOT/.claude/hooks/change-graph-reminder.sh"
if [ ! -f "$CANONICAL" ]; then
  echo "переходник указывает на отсутствующий канонический хук: .claude/hooks/change-graph-reminder.sh" >&2
